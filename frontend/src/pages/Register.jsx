                        ...
                        {["Account", "Info", "Verify"].map((label, i) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    <span
                                        className={`text-xs font-medium ${step === i + 1
                                            ? "text-white"
                                            : "text-white/60"
                                            }`}
                                    >
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p className="mt-2 text-sm text-gray-600">
                                            Select the type of account that best
                                            fits your needs
                                        </p>
                                    </div>
...
const RoleCard = ({ title, description, Icon,features, selected, onClick }) => (
    ...
    >
        <div className="flex items-start gap-3">
            <div
                className={`p-2 rounded-lg ${selected
            ...
            <div className="flex-1 text-left">
                <h3
                    className={`text-sm font-medium ${selected ? "text-primary" : "text-gray-900"
                        }`}
                >
                    {title}
                </h3>
